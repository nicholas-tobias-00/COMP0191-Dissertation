"""I-03b figures: same 3-figure format as i03_plots.py (overall ranking bar chart, per-tower top-8,
species-split zoom), from the already-saved i03b_b18champion_importance*.csv outputs. No new model
calls."""
import os
...
overall = pd.read_csv(f"{RESULTS}/i03b_b18champion_importance_ranked.csv", index_col=0)
by_tower = pd.read_csv(f"{RESULTS}/i03b_b18champion_importance_by_tower.csv")
...
ax.set_title("Permutation Sensitivity for TabPFN across 3 Towers × 5 Years")
...
fig.tight_layout()
fig.savefig(f"{FIGDIR}/i03b_overall_ranking.png", dpi=150)
print("Saved i03b_overall_ranking.png")
...
fig.suptitle("Permutation Sensitivity for TabPFN across 3 Towers × 5 Years", y=1.02)
fig.tight_layout()
fig.savefig(f"{FIGDIR}/i03b_per_tower_top8.png", dpi=150, bbox_inches="tight")
print("Saved i03b_per_tower_top8.png")
...
ax.set_title("Permutation Sensitivity for TabPFN across 3 Towers × 5 Years")
fig.tight_layout()
fig.savefig(f"{FIGDIR}/i03b_species_split.png", dpi=150)
print("Saved i03b_species_split.png")
